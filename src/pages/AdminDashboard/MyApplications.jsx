              ...
              return (
                <tr key={app._id} className="hover:bg-gray-50 border-b">
                  <td className="font-bold">
                    {s.universityName || app.universityName || "N/A"}
                  </td>
                  <td>
                    {s.city && s.country ? `${s.city}, ${s.country}` : "N/A"}
                  </td>
          ...
          <div className="modal-box max-w-2xl">
            ...
            <div className="space-y-3">
              ...
              <p>
                ...
                {selectedApp.scholarshipDetails?.scholarshipName || "N/A"}
              </p>
              <p>
                <strong>Status:</strong> {selectedApp.status}
              </p>
              <p>
                <strong>Fees Paid:</strong> ${selectedApp.paidFees || 0}
              </p>
              <p>
              ...
              <p>
                <strong>Feedback:</strong> {selectedApp.feedback || "None"}
              </p>
            </div>
          ...
          <div className="modal-box max-w-md">
            ...
            <div className="space-y-4">
              ...
              <textarea
                ...
                onChange={(e) =>
                  setReviewApp({ ...reviewApp, comment: e.target.value })
                }
                rows={4}
              />
            </div>
