      ...
      <div className="bg-white shadow-2xl rounded-xl p-6 md:p-10 border border-gray-200">
        ...
        <div className="flex flex-col items-center space-y-6">
          ...
          <div className="relative">
            ...
            {/* Role Badge */}
            <span
              className={`absolute bottom-1.5 right-[-16px] px-3 py-1 text-xs font-semibold border-1 border-white shadow-md rounded-full text-white ${
                userRole === "Admin" ? "bg-red-500" : "bg-green-400"
              }`}
            >
              {userRole}
            </span>
